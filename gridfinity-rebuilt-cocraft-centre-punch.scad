...
module center_punch() {
    ...
    diameter_handle = 11.2;
    lenght_handle = 68.5;

    rotate([90,0,0])
    cylinder(d=diameter_punch, h=lenght_punch, center=true);

    translate([0,lenght_punch/2-lenght_mark/2-6,0])
    rotate([90,0,0])
    cylinder(d=diameter_mark, h=lenght_mark, center=true);

    translate([0,lenght_punch/2-lenght_handle/2-6-lenght_mark,0])
    rotate([90,0,0])
    cylinder(d=diameter_handle, h=lenght_handle, center=true);
}
