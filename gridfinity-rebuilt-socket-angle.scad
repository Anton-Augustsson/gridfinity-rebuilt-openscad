...
module angle_socket() {
    ...
    translate([0,lenght_thick/2,0])
    rotate([90,0,0])
    cylinder(d=diameter_thick, h=lenght_thick, center=true);

    translate([0,-lenght_thin/2,0])
    rotate([90,0,0])
    cylinder(d=diameter_thin, h=lenght_thin, center=true);
}
