...
union(){
    base_thickness = 5;
    y_pos_plier_divider_screw = 55;
    y_pos_plier_stand_screw = -65;

    x_pos_diff_plier_screw = 27;
    x_pos_start_plier_divider_screw = -2*x_pos_diff_plier_screw;
    x_pos_start_plier_stand_screw = -(1+1/2)*x_pos_diff_plier_screw;
    ...
    for ( i = [0 : 4] ){
        translate([ x_pos_start_plier_divider_screw + x_pos_diff_plier_screw*i,
                    y_pos_plier_divider_screw,
                    -base_thickness])
        #plier_divider_screws(12);
    }
    for ( i = [0 : 3] ){
        translate([ x_pos_start_plier_stand_screw + x_pos_diff_plier_screw*i,
                    y_pos_plier_stand_screw,
                    -base_thickness])
