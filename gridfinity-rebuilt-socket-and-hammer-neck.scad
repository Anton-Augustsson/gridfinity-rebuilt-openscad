...
module sliding_socket(length) {
    diameter = 13.3;
    translate([0,length/2,diameter/2])
    rotate([90,0,0])
...
difference() {
    union() {
        ...
        translate([14.2,0,10.5+5/2])
        cube([55,30,5],center=true);

        translate([4,0,10.5+13/2])
        cube([35,30,13],center=true);
    }
